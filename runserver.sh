...
lunchbreakmapstring="MAP01 MAP02 MAP03 MAP04 MAP05 MAP06 MAP07 MAP09 MAP10 MAP13 MAP14 MAP20 MAP22 MAP28 MAP31 MAP32"
...
if ! grep -q "coop" /app/config/${oconfigfile}; then
  ...
  elif [[ "$oconfigfile" == "coop-lunchbreak.cfg" ]]; then
    mapstring=""
  else
